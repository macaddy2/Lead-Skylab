    ...
    return (
        <div className="animate-fadeIn">
            ...
            <div className="grid grid-cols-4 mb-6">
                <div className="card metric-card primary p-5">
                ...
                <div className="card metric-card success p-5">
                    <div className="flex items-center justify-between mb-2">
                ...
                <div className="card metric-card warning p-5">
                    <div className="flex items-center justify-between mb-2">
                ...
                <div className="card metric-card secondary p-5">
                    <div className="flex items-center justify-between mb-2">
